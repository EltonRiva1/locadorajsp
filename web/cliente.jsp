<%-- 
    Document   : cliente
    Created on : 30/04/2016, 13:40:32
    Author     : notle
--%>
            ...
            <div class="topo">
                <div class="corpo">
                    <form name="form1" action="cliente.jsp"
                        ...
                        <input type="text"
                               name="cli_endereco" value="<jsp:getProperty
                                   name="cliente" property="cli_endereco"/>"/>
                        <br>
                        <label>Telefone</label>
                        <input type="text"
                               name="cli_telefone" value="<jsp:getProperty
                                   name="cliente" property="cli_telefone"/>"/>
                        <br>
                        <label>Celular</label>
                        <input type="text"
                               name="cli_celular" value="<jsp:getProperty
                                   name="cliente" property="cli_celular"/>"/>
                        <br>
                        <label>E-mail</label>
                        <input type="text"
                               name="cli_email" value="<jsp:getProperty name="cliente"
                                                property="cli_email"/>"/>
                        <br>
                        <label>CPF</label>
                        <input type="text" name="cli_cpf"
                               value="<jsp:getProperty name="cliente"
                                                property="cli_cpf"/>"/>
                        <br>
                        <label>Usuário</label>
                        <input type="text"
                               name="cli_usuario" value="<jsp:getProperty
                                   name="cliente" property="cli_usuario"/>"/>
                        <br>
                        <label>Senha</label>
                        <input type="password"
                               name="cli_senha" value="<jsp:getProperty name="cliente"
                                                property="cli_senha"/>"/>
                        <br>
